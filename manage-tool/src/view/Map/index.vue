 ...
 * @LastEditTime: 2022-09-20 23:03:22
...
export default {
  ...
  methods: {
    drawMap() {
      ...
      //初始化地图,设置中心点坐标和地图级别
      map.centerAndZoom(new window.BMapGL.Point(121.56847909, 29.8100979777), 17);
      //开启鼠标滚轮缩放
      map.enableScrollWheelZoom(true);

      // var navi3DCtrl = new window.BMapGL.NavigationControl3D(); // 添加3D控件
